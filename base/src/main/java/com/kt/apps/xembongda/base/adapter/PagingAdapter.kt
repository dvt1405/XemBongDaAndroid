...
abstract class PagingAdapter<T, AD : ViewDataBinding, VB : ViewDataBinding, LOADING_DB : ViewDataBinding> : BaseAdsAdapter<T, AD, VB>() {
    ...
    abstract class BaseLoadingViewHolder<VB : ViewDataBinding>(val viewBinding: VB) : RecyclerView.ViewHolder(viewBinding.root) {
