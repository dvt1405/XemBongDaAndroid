...
public class TemplateView extends FrameLayout {
    ...
    private void applyStyles() {
        ...
        if (styles.getCallToActionBackgroundTintColor() != 0) {
            int ctaColor = styles.getCallToActionBackgroundTintColor();
            if (callToActionView != null) {
                GradientDrawable shapeDrawable = (GradientDrawable) ContextCompat.getDrawable(getContext(), R.drawable.gnt_background_corner);
                shapeDrawable.setColor(ctaColor);
                callToActionView.setBackground(shapeDrawable);
    ...
    public void setNativeAd(NativeAd nativeAd) {
        ...
        if (mediaView != null) {
            if (nativeAd.getMediaContent() != null) {
                Log.e("TAG", "setNativeAd: MediaContent");
                mediaView.setMediaContent(nativeAd.getMediaContent());
            } else {
                mediaView.setBackground(icon.getDrawable());
            }
        }
