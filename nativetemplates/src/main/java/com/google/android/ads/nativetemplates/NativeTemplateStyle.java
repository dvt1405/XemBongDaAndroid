...
public class NativeTemplateStyle {
  ...
  private int callToActionBackgroundTintColor;
  ...
  public int getCallToActionBackgroundTintColor() {
    return callToActionBackgroundTintColor;
  }
  ...
  public static class Builder {
    ...
    public Builder withCallToActionBackgroundColor(int callToActionBackgroundColor) {
      this.styles.callToActionBackgroundTintColor = callToActionBackgroundColor;
      return this;
    }
